...
public class MycarCommentController {
	...
	/*
	 * @PostMapping("/addcomment") public String addComment(@RequestBody
	 * MycarCommentDto dto) { MycarDto
	 * mycar=MycarDto.builder().num(dto.getNum()).build(); MycarCommentDto
	 * commentDto=MycarCommentDto.builder() .mycar(mycar) .build();
	 * 
