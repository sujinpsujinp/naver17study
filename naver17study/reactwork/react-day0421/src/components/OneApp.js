...
//Hooks 문법이 리액트 v.16.8에서 새로 도입되면서 일반 함수형태로 변경
...
//html 과 jsx 차이점
//1. 모든 요소는 짝이 맞아야한다(예: br, img 등등도 짝이 맞아야 한다)
    ...
    render(){ //class는 render 가 있어야함
        return (
            ...
            <div style={{backgroundColor:'orange',width:'300px',height:'200px'}}>
                ...
                나중에 라우터에서 문제 생길 수 있음 */}
                <img alt="" src="./mycar13.png" style={{width:'100px'}}/>
                
                {/*src의 이미지는 import 후 가져오거나 require 명령어를 이용 */}
...
//export default OneApp; //default는 단 한번만 사용이 가능, 이 경우는 import 시에 내 마음대로 이름을 정해도 됨